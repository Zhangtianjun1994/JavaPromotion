...
public class DL2016Test {

	public static void main(String[] args) {
		FJ_OF_Month fj = new FJ_OF_Month();	
		System.out.println("开始测试GM模型的应用");
		System.out.println("*****************对大连市2016年的房价进行相关的预测***************");
		//fj.insertToPrice();
		//返回2008-2016年的平均房价序列
		double list_read[] = fj.return_DL_2016Avgprice();
...
//	    //根据Gm模型预测，得到预测序列
		...
		System.out.println("2016年12月份大连市实际房价平均数据为：12344.11");
		System.out.println("根据GM模型预测的2016年12月份大连市平均房价为："+nextYear/6.0);
